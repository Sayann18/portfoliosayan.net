...
const Contact = () => {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('sayan.chakraborty@example.com')
    setCopied(true)
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-900 font-medium">sayan.chakraborty@example.com</span>
                  <button
                    onClick={copyEmail}
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <p className="text-gray-900 font-medium">Haldia, West Bengal, India</p>
              </div>
                ...
                <div className="flex gap-3">
                  {socialLinks.map((social) => (
                    <a
                      key={social.name}
                      href={social.href}
                      className="w-11 h-11 rounded-xl bg-purple-50 flex items-center justify-center text-gray-600 hover:bg-purple-100 hover:text-purple-700 transition-all duration-300"
                      title={social.name}
                    >
                      {social.icon}
                    </a>
